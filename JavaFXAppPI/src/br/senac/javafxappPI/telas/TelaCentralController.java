...
public class TelaCentralController {
    ...
    private void Inserir(ActionEvent event) throws IOException {
        ...
        if (editMode != true) {
            ...
            //Configura os valores no item de modelo
            clienteEdicao.setCpf(Integer.parseInt(txtCpf.getText()));
            ...
            clienteEdicao.setGenero(cbGenero.getValue());
    ...
    private void Alterar(ActionEvent event) throws IOException {
        ...
        if (cliente != null) {
            ...
            txtCpf.setText(Integer.toString(clienteEdicao.getCpf()));
            ...
            cbGenero.setValue(clienteEdicao.getGenero());
